@extends('master')
@section('title', 'Portfolio Francois Hébert')
@section('content')
                ...
                <div class="col-xxl-5">
                    ...
                    <div class="text-center text-xxl-start">
                        ...
                        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                            <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder" href="resume">CV</a>
                ...
                <div class="col-xxl-8">
                    <div class="text-center my-5">
                        ...
                        <div class="d-flex justify-content-center fs-2 gap-4">
                            ...
                            <a class="text-gradient" href="https://github.com/fhmaisonneuve/" target="_blank"><i class="bi bi-github"></i></a>
                        </div>
                    </div>
                </div>
            </div>
